...
def render_dashboard():
    ...
    exported_figs = {}
    # ==========================================
    # 🌟 Premium Dashboard Hero Banner (Pure CSS Text Logo)
    # ==========================================
    banner_html = """
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,800;1,600&family=Montserrat:wght@500&display=swap');
    </style>
    <div style="position: relative; width: 100%; height: 220px; border-radius: 16px; margin-bottom: 30px; background: radial-gradient(circle, #ffffff 0%, #f4f7fa 100%); box-shadow: 0 10px 30px rgba(0,0,0,0.10); border: 1px solid rgba(255,255,255,0.8); display: flex; justify-content: center; align-items: center; overflow: hidden;">
        <div style="position: absolute; top: -50px; left: -50px; width: 250px; height: 250px; background: rgba(0, 210, 255, 0.08); border-radius: 50%; filter: blur(30px);"></div>
