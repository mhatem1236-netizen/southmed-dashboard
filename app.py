...
if uploaded_file is not None:
    ...
    create_card(col1, "Total Requests", current_metrics["Total_Requests"], delta_html=d1)
    ...
    if sim_days_saved > 0:
        ...
        st.markdown(f"""
            <div class="simulator-card">
                ...
                <p style="font-size: 14px; color: #d1d5da; margin: 0;">Reducing paperwork cycle times by {sim_days_saved} days across all active requests accelerates overall sector handovers.</p>
            </div>
            """, unsafe_allow_html=True)
    ...
    r1.error(f"**Rejected/Revise Samples:** {rejected_count} samples")
